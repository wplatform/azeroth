        ...
        class spell_malygos_arcane_storm_SpellScript : public SpellScript
        {
            ...
            void FilterTargets(std::list<WorldObject*>& targets)
            {
                ...
                if (GetSpellInfo()->Id == SPELL_ARCANE_STORM_P_III)
                {
                    ...
                    Trinity::Containers::RandomResize(targets, check, (malygos->GetMap()->GetDifficulty() == DIFFICULTY_10_N ? 4 : 10));
                }
                else
                    Trinity::Containers::RandomResize(targets, (malygos->GetMap()->GetDifficulty() == DIFFICULTY_10_N ? 4 : 10));
            }
